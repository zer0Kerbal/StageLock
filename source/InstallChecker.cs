...
namespace StageLock
{
    ...
    {
        private const string MODNAME = "StageLock";
        private const string FOLDERNAME = "StageLock";
        ...
        protected void Start()
        {
            ...
            if (assemblies.Any())
            {
                ...
                (
                    ...
                    new Vector2(0.5f, 0.5f),
                    "test",
                    Localizer.Format("#StageLock_InstallChecker_title", MODNAME),//"Incorrect " +  + " Installation" 
